...
3- Seção de cardápio com descrições e imagens dos produtos.

4- Informações de contato e localização da cafeteria.

5- Animações simples para melhorar a interação do usuário.

6- Código limpo e organizado, facilitando futuras manutenções e melhorias.

Este projeto foi desenvolvido para exercitar conceitos de design web e front-end.